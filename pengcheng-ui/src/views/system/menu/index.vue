...
const formData = reactive<SysMenu>({ ...defaultFormData })
let formSnapshot: SysMenu = { ...defaultFormData }
...
function handleFormReset() {
  Object.assign(formData, { ...formSnapshot })
