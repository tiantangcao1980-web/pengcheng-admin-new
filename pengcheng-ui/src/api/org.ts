...
export const configGroupApi = {
  ...
  getPublicConfig(): Promise<{
    system: { siteName: string; siteDescription: string; siteLogo: string; copyright: string; icp: string; watermarkEnabled?: boolean; watermarkType?: string; watermarkOpacity?: number }
    ...
    return request({ url: '/sys/config-group/public', method: 'get', _silent: true })
  },
  // 测试支付
