    ...
    public Map<String, Object> refund(String outTradeNo, String outRefundNo, 
        ...
        try {
            ...
            com.wechat.pay.java.service.refund.RefundService refundService =
                new com.wechat.pay.java.service.refund.RefundService.Builder()
                    .config(wechatConfig)
                    .build();
            ...
            com.wechat.pay.java.service.refund.model.AmountReq amountObj =
                new com.wechat.pay.java.service.refund.model.AmountReq();
            amountObj.setTotal(amount.longValue());
            amountObj.setRefund(amount.longValue());
            amountObj.setCurrency("CNY");
            request.setAmount(amountObj);
            
            com.wechat.pay.java.service.refund.model.Refund refund = 
