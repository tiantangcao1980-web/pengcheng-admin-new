package com.pengcheng.gen.service.impl;
...
import com.pengcheng.gen.entity.*;
import com.pengcheng.gen.mapper.GenTableColumnMapper;
import com.pengcheng.gen.mapper.GenTableMapper;
...
import com.pengcheng.gen.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public void importTable(String[] tableNames) {
        for (String tableName : tableNames) {
            ...
            table.setPackageName("com.pengcheng.system");
    ...
    public List<String> previewGenerateFiles(Long tableId) {
        ...
        if (projectRoot.endsWith("pengcheng-web")) {
    ...
    public List<String> generateToProject(Long tableId) {
        ...
        // 获取项目根目录
        String projectRoot = System.getProperty("user.dir");
        // 如果是在 pengcheng-web 目录下运行，需要找到项目根目录
        if (projectRoot.endsWith("pengcheng-web")) {
            projectRoot = projectRoot.substring(0, projectRoot.length() - 8);
        }
    ...
    private String getProjectFilePath(GenTable table, String fileName, String projectRoot) {
        ...
        return switch (fileName) {
            case "Entity.java" -> projectRoot + "/pengcheng-core/pengcheng-system/src/main/java/com/pengcheng/system/entity/" + className + ".java";
            case "Mapper.java" -> projectRoot + "/pengcheng-core/pengcheng-system/src/main/java/com/pengcheng/system/mapper/" + className + "Mapper.java";
            case "Service.java" -> projectRoot + "/pengcheng-core/pengcheng-system/src/main/java/com/pengcheng/system/service/" + className + "Service.java";
            case "ServiceImpl.java" -> projectRoot + "/pengcheng-core/pengcheng-system/src/main/java/com/pengcheng/system/service/impl/" + className + "ServiceImpl.java";
            case "Controller.java" -> projectRoot + "/pengcheng-api/pengcheng-admin-api/src/main/java/com/pengcheng/admin/controller/" + moduleName + "/" + className + "Controller.java";
            case "api.ts" -> projectRoot + "/pengcheng-ui/src/api/" + businessName + ".ts";
            case "index.vue" -> projectRoot + "/pengcheng-ui/src/views/" + moduleName + "/" + businessName + "/index.vue";
    ...
    private String getFilePath(GenTable table, String fileName) {
        ...
        return switch (fileName) {
            ...
            case "Controller.java" -> "com/pengcheng/web/controller/" + table.getModuleName() + "/" + className + "Controller.java";
